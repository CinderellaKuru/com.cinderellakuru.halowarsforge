...
public class RenderScenarioWindow : EditorWindow
{
    ...
    private ScenarioManager Script;

    [MenuItem("Tools/Scenario Editor")]
    public static void ShowWindow()
    {
        RenderScenarioWindow window = (RenderScenarioWindow)EditorWindow.GetWindow(typeof(RenderScenarioWindow));
    ...
    {
        Script = FindObjectOfType<ScenarioManager>();
        if (Script != null)
        {
